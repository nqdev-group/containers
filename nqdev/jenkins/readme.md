...
[![Docker Stars](https://img.shields.io/docker/stars/nqdev/jenkins.svg)](https://hub.docker.com/r/nqdev/jenkins)
[![Docker Pulls](https://img.shields.io/docker/pulls/nqdev/jenkins.svg)](https://hub.docker.com/r/nqdev/jenkins)
[![Join the chat at https://gitter.im/jenkinsci/docker](https://badges.gitter.im/jenkinsci/docker.svg)](https://gitter.im/jenkinsci/docker?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)

The Jenkins Continuous Integration and Delivery server [available on Docker Hub](https://hub.docker.com/r/nqdev/jenkins).

This is a fully functional Jenkins server.
[https://jenkins.io/](https://jenkins.io/).
[Jenkins War Packages](https://get.jenkins.io/war/): https://get.jenkins.io/war/
...
```
docker run --name myjenkins -p 8080:8080 -p 50000:50000 --restart=on-failure --env JAVA_OPTS=-Dhudson.footerURL=http://mycompany.com nqdev/jenkins:lts-jdk21
```
...
EOF
docker run --name myjenkins -p 8080:8080 -p 50000:50000 --restart=on-failure --env JAVA_OPTS="-Djava.util.logging.config.file=/var/jenkins_home/log.properties" -v `pwd`/data:/var/jenkins_home nqdev/jenkins:lts-jdk21
```
...
```
docker run -p 8080:8080 -p 50000:50000 --restart=on-failure --dns 1.1.1.1 --dns 8.8.8.8 nqdev/jenkins:lts-jdk21
```
...
```
docker run nqdev/jenkins:lts-jdk21 --version
```
...
```
docker run --name myjenkins -p 8080:8080 -p 50001:50001 --restart=on-failure --env JENKINS_SLAVE_AGENT_PORT=50001 nqdev/jenkins:lts-jdk21
```
...
The naming convention for the tags on Docker Hub follows the format `<repository_name>:<tag>`, where the repository name is nqdev/jenkins and where the tag specifies the image version.
...
For example, to pull the LTS version of the Jenkins image use this command: `docker pull nqdev/jenkins:lts`
...
The Jenkins container is based on the `nqdev/jenkins:lts` image and exposes the Jenkins web interface on port 8080.
...
```command
JENKINS_IMAGE=nqdev/jenkins:lts-jdk21
